...
const ProductSidebar = () => {
    ...
    useEffect(() => {
        ...
        console.log('Paths:', pathname.split('/').filter(Boolean));
        ...
        if (productNav?.submenu) {
            ...
            if (currentPath.startsWith('/products')) {
                ...
                if (categoryParam) {
                    ...
                    const matchingCategory = productNav.submenu.find(submenu => {
    ...
    const toggleCategory = (title: string) => {
        // Log để debug
        console.log('Toggle product category clicked:', title, 'Current expanded:', expandedCategory, 'Animating:', animating);
        ...
        if (expandedCategory === title) {
            ...
            router.push(`/products?category=${encodeURIComponent(title)}`);

            // Log thành công
            console.log('Expanded category to:', title);
        }
